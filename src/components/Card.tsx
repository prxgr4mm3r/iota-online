        ...
        return (
            <>
                {plusConfigs[num].map((pos, idx) => (
                    <g
                        key={idx}
                        transform={`translate(${pos.x - shapeSize / 2}, ${pos.y - shapeSize / 2})`}
                    >
...
export default function Card({ card }: { card: T }) {
    if (card.kind === 'wild') {
        return (
            <div className="grid aspect-square w-[7.5vw] max-w-[180px] min-w-[120px] place-items-center rounded-2xl bg-white shadow-lg">
    ...
    return (
        <div className="aspect-square w-[7.5vw] max-w-[180px] min-w-[120px] overflow-hidden rounded-2xl bg-white shadow-lg">
